...
if(strpos($res['num'], '0') === 0) {
        $res['num'] = substr($res['num'],1);
}
$post_data = array(
...
$post_data = array(
    ...
    'From'   => '8808891988',
    'To'    => $res['num'],
    'Body'  => 'How did the session with your mentor go? Please give a feedback with 1 being excellent and 5 being bad',
);
